...
Priprava a spracovanie dat pre dalsie ulohy su v subore `bike_rental.ipynb`, v sekcii 1. Data Preparation. Data som nacital pomocou kniznice pandas do dataframe. Dataset obsahuje 8741 riadkov a 12 stlpcov.
...
Trening modelov je v subore `bike_rental.ipynb`, v sekcii 4. Model Training. Pouzil som tri modely: Decision Tree Regressor, Random Forest Regressor a Support Vector Machine z kniznice `sklearn`.
